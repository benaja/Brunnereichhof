...
@section('content')
    ...
    <tr>
        <td>
            ...
            Brauchen Sie unsere Hilfe auf ihren Feldern? Bitte erfassen sie ihre geplanten Arbeiten <a href="https://rapport2.brunnereichhof.ch">hier</a>.</p>
        </td>
    </tr>
    ...
    <tr>
        <td>
            <p>Anmelden können Sie sich auf <a href="https://rapport2.brunnereichhof.ch">unserer Website</a>.</p>
