<template>
  <div class="container">
    <h1 class="text-center">Kunde auswählen</h1>
        ...
        <v-list class="pa-0 elevation-1">
          <template v-for="(rapport, index) of rapports">
            <div :key="index">
              ...
              <v-list-item :to="'/rapport/' + rapport.id" color="primary">
                <v-list-item-content>{{rapport.customer.firstname}} {{rapport.customer.lastname}}</v-list-item-content>
                <v-list-item-avatar>
